...
//
//public class ListData extends AppCompatActivity implements AdapterListBasic.OnItemClickListener {
//
//    RecyclerView lstBiodata;
//    private List<DataScript> biodataList;
...
//    }
//
//    public List<DataScript> loadData(){
//        List<DataScript> biodataList = null;
//        String dataJson = SharedPrefUtil.getInstance(ListData.this).getString("data_input");
//        if (!dataJson.isEmpty()) {
//            Gson gson = new Gson();
//            Type type = new TypeToken<List<DataScript>>() {}.getType();
//            biodataList = gson.fromJson(dataJson, type);
//            for (DataScript data : biodataList) {
...
//        adapter = new AdapterListBasic(ListData.this, biodataList);
//        adapter.setOnItemClickListener(ListData.this);
//        runOnUiThread(new Runnable() {
//            @Override
//            public void run() {
//                lstBiodata.setLayoutManager(new LinearLayoutManager(ListData.this));
...
//                    biodataList = new ArrayList<DataScript>();
//                    for (DataSnapshot npsnapshot : dataSnapshot.getChildren()){
//                        DataScript b = npsnapshot.getValue(DataScript.class);
//                        biodataList.add(b);
//                    }
//                    adapter = new AdapterListBasic(ListData.this,biodataList);
//                    lstBiodata.setAdapter(adapter);
